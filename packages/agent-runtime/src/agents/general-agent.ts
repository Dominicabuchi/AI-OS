...
export class GeneralAgent extends BaseAgent {
  ...
  readonly description =
    "Primary autonomous reasoning and execution agent for AI-OS.";
...
` + composioCapabilityContext("general");

  readonly agentDependencies = [];

  readonly runtimeCapabilities = ["tool-execution", "memory", "task-management"];
...
Create the highest-quality execution plan.
