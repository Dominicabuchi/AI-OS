...
` + composioCapabilityContext("browser");  readonly agentDependencies = [];

  readonly runtimeCapabilities = ["tool-execution", "browser-execution"];
...
Verify every important browser action.

Preserve existing browser sessions whenever possible.
